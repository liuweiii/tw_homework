# -*- coding: utf-8 -*-
from models.discount import Buy2Free1, Discount95, NoDiscount

DEFAULT_CLAZZ = u"商品"

products = {
    "ITEM000001": {"name": u"羽毛球", "unit": u"个", "price": 1.00, "clazz": DEFAULT_CLAZZ, "discount": Buy2Free1()},
    ...
    "ITEM000005": {"name": u"可口可乐", "unit": u"瓶", "price": 3.00, "clazz": DEFAULT_CLAZZ, "discount": Buy2Free1()},
}
